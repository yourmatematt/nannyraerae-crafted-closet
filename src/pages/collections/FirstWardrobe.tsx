...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Page Heading */}
      <h1 className="text-4xl font-bold text-gray-900 mb-4">First Wardrobe</h1>
      <p className="text-lg text-gray-600 mb-10">
        Essential pieces for baby's first wardrobe, crafted with extra care for delicate skin
      </p>
...
const FirstWardrobe = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['firstWardrobeCollection', selectedAgeGroup, selectedPriceRange, selectedGender],
    queryFn: async () => {
      // Create mock data for First Wardrobe collection
      const mockProducts = [
        {
          id: 1,
          ...
          badge: "First Wardrobe",
          stock_quantity: 8,
          in_stock: true,
          age_group: "3mths",
          collection: "First Wardrobe"
        },
        {
          id: 2,
          name: "Bamboo Sleep Gown",
          price: 45,
          image_url: null,
          created_at: new Date().toISOString(),
          badge: "First Wardrobe",
      ...
      try {
        let query = supabase
          ...
          .select('*')
          .eq('is_active', true)
          .like('collection', '%First Wardrobe%')
