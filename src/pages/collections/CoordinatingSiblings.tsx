...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Page Heading */}
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Coordinating Siblings</h1>
      <p className="text-lg text-gray-600 mb-10">
        Matching and complementary outfits designed for brothers and sisters to coordinate beautifully
      </p>
...
const CoordinatingSiblings = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['coordinatingSiblingsCollection', selectedAgeGroup, selectedPriceRange, selectedGender],
    queryFn: async () => {
      // Create mock data for Coordinating Siblings collection
      const mockProducts = [
        {
          id: 1,
          name: "Matching Stripe Set (2pc)",
          price: 135,
          image_url: null,
          created_at: new Date().toISOString(),
          badge: "Coordinating Siblings",
          stock_quantity: 3,
          in_stock: true,
          age_group: "1yr",
          collection: "Coordinating Siblings"
        },
        {
          id: 2,
          name: "Twin Denim Collection",
          price: 155,
          image_url: null,
          created_at: new Date().toISOString(),
          badge: "Coordinating Siblings",
      ...
      try {
        let query = supabase
          ...
          .select('*')
          .eq('is_active', true)
          .like('collection', '%Coordinating Siblings%')
...
export default CoordinatingSiblings;