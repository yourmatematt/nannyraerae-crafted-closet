...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Page Heading */}
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Eco-Conscious</h1>
      <p className="text-lg text-gray-600 mb-10">
        Sustainably made pieces using organic materials and eco-friendly processes
      </p>
...
const EcoConscious = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['ecoConsciousCollection', selectedAgeGroup, selectedPriceRange, selectedGender],
    queryFn: async () => {
      // Create mock data for Eco-Conscious collection
      const mockProducts = [
        {
          id: 1,
        ...
        {
          id: 6,
          name: "Earth-Friendly Collection",
          price: 155,
          image_url: null,
          created_at: new Date().toISOString(),
          badge: "Eco-Conscious",
