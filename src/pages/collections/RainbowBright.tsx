...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Page Heading */}
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Rainbow Bright</h1>
      <p className="text-lg text-gray-600 mb-10">
        Vibrant colors and playful patterns that celebrate childhood joy and creativity
      </p>
...
const RainbowBright = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['rainbowBrightCollection', selectedAgeGroup, selectedPriceRange, selectedGender],
    queryFn: async () => {
      // Create mock data for Rainbow Bright collection
      const mockProducts = [
        {
          id: 1,
          ...
          badge: "Rainbow Bright",
          stock_quantity: 7,
          in_stock: true,
          age_group: "2yrs",
          collection: "Rainbow Bright"
        },
        {
          id: 2,
          name: "Colorful Butterfly Set",
          price: 65,
          image_url: null,
          created_at: new Date().toISOString(),
          badge: "Rainbow Bright",
      ...
      try {
        let query = supabase
          ...
          .select('*')
          .eq('is_active', true)
          .like('collection', '%Rainbow Bright%')
