...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Page Heading */}
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Garden Party</h1>
      <p className="text-lg text-gray-600 mb-10">
        Whimsical florals and soft pastels perfect for spring celebrations and garden adventures
      </p>
