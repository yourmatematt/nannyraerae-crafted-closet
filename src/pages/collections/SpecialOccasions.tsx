...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Page Heading */}
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Special Occasions</h1>
      <p className="text-lg text-gray-600 mb-10">
        Elegant pieces for life's memorable moments and celebrations
      </p>
...
const SpecialOccasions = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['specialOccasionsCollection', selectedAgeGroup, selectedPriceRange, selectedGender],
    queryFn: async () => {
      // Create mock data for Special Occasions collection
      const mockProducts = [
        {
          id: 1,
      ...
      try {
        let query = supabase
          ...
          .select('*')
          .eq('is_active', true)
          .like('collection', '%Special Occasions%')
