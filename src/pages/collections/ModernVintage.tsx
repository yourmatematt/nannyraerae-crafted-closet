...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Page Heading */}
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Modern Vintage</h1>
      <p className="text-lg text-gray-600 mb-10">
        Timeless elegance meets contemporary style in our curated vintage-inspired pieces
      </p>
...
const ModernVintage = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['modernVintageCollection', selectedAgeGroup, selectedPriceRange, selectedGender],
    queryFn: async () => {
      // Create mock data for Modern Vintage collection
      const mockProducts = [
        {
          id: 1,
      ...
      try {
        let query = supabase
          ...
          .select('*')
          .eq('is_active', true)
          .like('collection', '%Modern Vintage%')
