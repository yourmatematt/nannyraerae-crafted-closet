...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Easter Gifts</h1>
      <p className="text-lg text-gray-600 mb-10">
        Beautiful spring designs perfect for Easter celebrations
      </p>
...
const Easter = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['easterGifts', selectedAgeGroup, selectedPriceRange],
    queryFn: async () => {
      // Create mock data for Easter gifts
      const mockProducts = [
        {
          id: 1,
          name: "Spring Blossoms Dress",
          price: 85,
          image_url: null,
