...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Starting School Gifts</h1>
      <p className="text-lg text-gray-600 mb-10">
        Confidence-building pieces for their big school adventure
      </p>
...
const StartingSchool = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['startingSchoolGifts', selectedAgeGroup, selectedPriceRange],
    queryFn: async () => {
      // Create mock data for starting school gifts
      const mockProducts = [
        {
          id: 1,
          name: "First Day Dress",
          price: 95,
          image_url: null,
        ...
        {
          id: 5,
          name: "Learning Adventure Outfit",
          price: 85,
          image_url: null,
          created_at: new Date().toISOString(),
          badge: "Educational",
      ...
      try {
        let query = supabase
          ...
          .eq('gift_category', 'Starting School')
