...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-4xl font-bold text-gray-900 mb-4">First Birthday Gifts</h1>
      <p className="text-lg text-gray-600 mb-10">
        Special pieces to celebrate their very first milestone birthday
      </p>
...
const FirstBirthday = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['firstBirthdayGifts', selectedAgeGroup, selectedPriceRange],
    queryFn: async () => {
      // Create mock data for first birthday gifts
      const mockProducts = [
        {
          id: 1,
        ...
        {
          id: 2,
          name: "First Birthday Romper Set",
          price: 65,
          image_url: null,
          created_at: new Date().toISOString(),
          badge: "Popular",
      ...
      try {
        let query = supabase
          ...
          .eq('gift_category', 'First Birthday')
