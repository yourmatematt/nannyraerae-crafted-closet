...
const FilterSection = memo(({
  ...
  <section className="py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Big Sibling Gifts</h1>
      <p className="text-lg text-gray-600 mb-10">
        Special pieces to celebrate their new role as a big brother or sister
      </p>
...
const BigSibling = () => {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ['bigSiblingGifts', selectedAgeGroup, selectedPriceRange],
    queryFn: async () => {
      // Create mock data for big sibling gifts
      const mockProducts = [
        {
          id: 1,
          name: "Big Sister Celebration Dress",
          price: 95,
          image_url: null,
        ...
        {
          id: 6,
          name: "Big Kid Responsibility Set",
          price: 155,
          image_url: null,
          created_at: new Date().toISOString(),
          badge: "Growing Up",
